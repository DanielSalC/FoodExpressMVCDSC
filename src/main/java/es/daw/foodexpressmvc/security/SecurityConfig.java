...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                 ...
                 */
                /*
                ¿Por qué SI necesitas CSRF en una Aplicación Web MVC monolitica??
                    - Si usas cookies para la autenticación, sino tokens JWT que van en el header (normalmente en Authorization: Bearer ...).
                    - Si hay formularios web ni sesiones HTML (como en aplicaciones MVC tradicionales).
                ...
                .formLogin(login -> login //*
                        .loginPage("/login")
                        .defaultSuccessUrl("/home", true) // * cambio
